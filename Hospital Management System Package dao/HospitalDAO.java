package com.dao;
	...
	public class HospitalDAO {
	    ...
	    private String jdbcURL = "jdbc:mysql://localhost:3306/hospital management?useSSL=false&serverTimezone=UTC";
	    ...
	    public void insertPatient(Patient patient) throws SQLException {
	        ...
	        try (Connection connection = getConnection();
				 ...
				 * preparedStatement.setInt(2, patient.getAge()); preparedStatement.setString(3,
				 * patient.getGender()); preparedStatement.setDate(4, new
				 * java.sql.Date(patient.getAdmissionDate().getTime()));
